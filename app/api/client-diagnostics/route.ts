...
const input = z.object({ kind: z.enum(["CHUNK_LOAD_ERROR", "SLOW_RESUME", "APP_SHELL_ERROR"]), durationMs: z.number().int().min(0).max(120000).optional(), swState: z.string().max(32).optional() });
