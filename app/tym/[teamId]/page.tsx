...
const GROUPS: { title: string; metrics: Metric[] }[] = [
  { title: "Góly a šance", metrics: ["GOALS_FOR", "GOALS_AGAINST", "XG", "SHOTS", "SHOTS_ON_TARGET"] },
  { title: "Výstavba hry", metrics: ["POSSESSION", "PASSES_TOTAL", "PASS_ACCURACY", "SHOTS_INSIDE_BOX", "SHOTS_OUTSIDE_BOX"] },
  { title: "Standardky a disciplína", metrics: ["CORNERS", "OFFSIDES", "FOULS", "YELLOW_CARDS", "RED_CARDS", "SAVES"] },
];
  ...
  return (
    <main className="app-page">
      ...
      <section className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard label="Forma" value={summary?.form.join(" · ") || "—"} note={`vzorek ${summary?.formSampleSize ?? 0} zápasů`} />
