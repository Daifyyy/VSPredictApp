 ...
 * uloženými λ (`PREDICT_PARAMS` v `lib/stats/predict.ts`). Historické pravděpodobnosti
 * jsou ale neměnný audit; kandidátní konstanty se ukládají jako paralelní SHADOW
 * kalibrace. Stejně tak pod ni nepatří λ rohů a karet – paralelní stopa
